...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/5">
      ...
      {/* CursorGlow has to span the full section - matching the static wash
          above - not just the centered content column, or the glow's own
          box stops at the column edge and leaves a visible seam where it
          meets the wider background behind it. The centered column lives
          inside it instead. */}
      <CursorGlow>
